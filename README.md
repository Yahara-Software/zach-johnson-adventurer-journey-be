...
- _This problem is meant as a starting point for interview discussion_
- _This is meant to be a simple problem with an open ended solution to see what you do with it_
- _Be prepared to talk about solving this problem in the context of a full development lifecycle_
